...
public class FraisForfaitService {
    ...
    public Optional<FraisForfait> getFraisForfaitById(String id) {
    ...
    public FraisForfait updateFraisForfait(String id, FraisForfait fraisForfait) {
    ...
    public void deleteFraisForfait(String id) {
        if (!fraisForfaitRepository.existsById(id)) {
            throw new IllegalArgumentException("FraisForfait with ID " + id + " does not exist.");
        }
